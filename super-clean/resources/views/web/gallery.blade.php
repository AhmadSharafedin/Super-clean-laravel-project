...
<head>
	<title>Cleaning Services Home Service Category Bootstrap Responsive Template | Gallery :: W3layouts</title>
	<!-- Meta tag Keywords -->
...
<body>
					...
					<ul class="navbar-nav ml-auto text-center">
						...
						<li class="nav-item dropdown active">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item active" href="gallery.blade.php">Gallery</a>
							</div>
						</li>
						<li class="nav-item">
	...
	<div class="contact py-5">
		<div class="container py-xl-5 py-lg-3">
			<h2 class="tittle mb-xl-5 mb-4 text-dark text-uppercase font-weight-bold pl-4 py-3">Gallery</h2>
			<ul class="demo">
				<li>
