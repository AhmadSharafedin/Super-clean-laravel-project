					...
					<ul class="navbar-nav ml-auto text-center">
						...
						<li class="nav-item dropdown active">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item active" href="single.blade.php">Cleaner's Blog</a>
				...
				<div class="row">
					...
					<div class="col-lg-8 left-blog-info text-left">
						<div class="blog-grid-top">
							...
							<h3>
								<a href="single.blade.php" class="single-text text-dark font-weight-light">Nemo enim ipsam voluptatem quia voluptas
							...
							<div class="tech-btm">
								...
								<div class="blog-grids row mb-3">
									...
									<div class="col-md-7 blog-grid-right">
										...
										<h5>
											<a href="single.blade.php">Pellentesque dui, non felis. Maecenas male non felis </a>
										</h5>
										<div class="sub-meta">
											<span>
							...
							<div class="single-gd tech-btm">
								...
								<div class="blog-grids">
									...
									<div class="blog-grid-right">
										<h5 class="mt-0">
											<a href="single.blade.php">Pellentesque dui, non felis. Maecenas male</a>
										</h5>
									</div>
