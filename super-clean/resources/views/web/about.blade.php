					...
					<ul class="navbar-nav ml-auto text-center">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="single.blade.php">Cleaner's Blog</a>
						...
						<li class="nav-item">
							<a class="nav-link" href="offers.blade.php">Our Offers</a>
						</li>
						<li class="nav-item">
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row w3ls-welcome-grids">
				<div class="col-xl-4 w3l-welcome-left">
					...
					<h5>Mollis porttitor nibh, id pellentesque mauris porta</h5>
					<p class="mt-3">Donec bibendum ligula sit amet auctor vulputate. Maecenas eget erat quis dapibus. Aenean eu
						scelerisque lacus, et fringilla
						odio.
						<span>Sed vestibulum sapien ornare ex sodales, eu feugiat ipsum amet aliquam non, sagittis eget justo. Curabitur
							mollis hendrerit
							nunc, id luctus sem vestibulum id.</span>
					</p>
				</div>
				...
				<div class="col-xl-4 w3l-welcome-left">
					<h4 class="mb-4 title-2-agiles">History of us</h4>
					<h5>Mollis porttitor nibh, id mauris porta et.</h5>
					<p class="mt-3">Duis interdum malesuada nunc, nec vestibulum erat sagittis quis. Nulla eget risus nec ligula
						volutpat lacinia.
						<span>Integer eleifend nec ligula vitae feugiat. Nulla eleifend mauris et elementum placerat.</span>
					</p>
					<div class="w3l-button">
						<a href="single.blade.php" class="btn btn-sm animated-button victoria-two text-dark mt-4">Read More</a>
					</div>
				</div>
			</div>
		</div>
