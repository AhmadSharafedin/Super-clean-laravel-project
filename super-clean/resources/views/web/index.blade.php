            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/about') }}" style="color: #002752;font-weight: bold;font-size: 20px">{{ __('About') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}" style="color: #002752;font-weight: bold;font-size: 20px">{{ __('Login') }}</a>
                            </li>

                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}" style="color: #002752;font-weight: bold;font-size: 20px">{{ __('Register') }}</a>
                                </li>
                            @endif
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('logout') }} " style="color: #002752;font-weight: bold;font-size: 20px"
		...
		<div class="container py-xl-5 py-lg-3">
			<div class="row">
				...
				<div class="col-lg-7 agileits_works-grid1 mt-lg-0 mt-4">
					<p>Super clean is cleaning services is committed to providing you with the highest quality of cleaning in the industry.
			...
			<div class="row">
				<div class="col-md-4 p-sm-0">
					<div class="icons-w3ls text-white p-4">
                        ...
                        <h5 class="text-uppercase"><a href="{{ url('/') }}">Places Cleaning</a></h5>
					</div>
					<p class="p-4">Cleaning houses, Offices &Gardens. Vacuums, washes dishes,
                         beds, cleans and scrubs counters, and dusts surfaces,Pruning and trimming trees and shrubs, sweeps floors, Re-edging and cleaning garden and flower.</p>
				</div>
				<div class="col-md-4 p-sm-0 my-md-0 my-5">
					<div class="icons-w3ls text-white p-4 mid-sec-agile">
						<h5 class="text-uppercase pb-2 text-center">Cars Cleaning</h5>
                        <i class="fas fa-car py-4"></i>

                    </div>
					<p class="p-4">Our service is completely eco-friendly. We use waterless car-wash solutions that wash, foe all type of cars Sedan, 4x4 and Van
                        wax and shine, in addition to a full arsenal of environmentally friendly supplies.  swipe prior to our posted daily deadline.</p>
				</div>
				<div class="col-md-4 p-sm-0">
					<div class="icons-w3ls text-white p-4">
                        <i class="fas fa-braille py-4"></i>

                        <h5 class="text-uppercase">Laundries Cleaning</h5>
					</div>
					<p class="p-4">Our team washes, cleans, and dries your laundry for folding – with 100% eco-friendly and high-quality detergents.</p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row">
				<div class="col-md-4 logo-2 text-md-right text-center">
					<a class="logo-footer" href="index.blade.php" >
						<img src="images/Untitled-1.png" alt="" class="img-fluid mt-3">
					</a>
				</div>
			</div>
		</div>
